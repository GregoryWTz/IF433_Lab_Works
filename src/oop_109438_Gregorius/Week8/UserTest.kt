...
fun runMockUnitTest() {
    ...
    // Du unit Testing, jika user null, kita HARAP testnya gagal (crash).
    // Maka penggunaan !! sangan lazim di file Testing
    val initial = testUser!!.name.substring(0, 1)

    // check() adalah fungsi bawaan kotlin untuk assertion
    check(initial == "T") { "Test Failed! Iinitial is wrong" }
